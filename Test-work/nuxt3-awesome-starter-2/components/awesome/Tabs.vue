...
<template>
  <div ref="tabs" class="tabs">
    <ClientOnly>
      <div
        class="tabs-header relative flex overflow-hidden rounded-t-lg bg-primary-700 px-5 py-3 text-sm text-gray-300 font-bold space-x-6"
      >
        <div
          v-for="item in tabItems"
          :key="item.name"
          class="tabs-header-item" :class="{
