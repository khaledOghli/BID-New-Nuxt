...
<template>
  <LayoutPageWrapper class="flex flex-1">
    <LayoutPageSection class="flex flex-1">
      <div class="flex flex-1 flex-col items-center justify-center">
        ...
        <div
          v-if="showAlert"
          class="mt-4 w-auto rounded bg-gray-800 px-4 py-1 text-center text-sm text-white"
        >
      ...
      <div class="absolute left-0 top-0 w-screen">
        <div class="absolute right-0 top-0 z-0 h-screen w-1/4 flex py-10 pt-12">
          <div
            class="rounded-l-9xl flex-1 from-blue-600/10 bg-gradient-to-l"
          />
        </div>
        <div class="absolute left-0 top-0 z-0 h-screen w-1/4 flex py-10 pt-12">
          <div
            class="rounded-r-9xl flex-1 from-green-600/10 bg-gradient-to-r"
          />
        </div>
      </div>
    </LayoutPageSection>
