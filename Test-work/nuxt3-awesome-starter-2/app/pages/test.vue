  ...
  <LayoutPageWrapper>
    ...
    <LayoutPageSection>
      ...
      <div class="mb-6">
        ...
        <div
          class="flex flex-col items-center justify-items-center md:flex-row space-y-2 md:space-x-2 md:space-y-0"
        >
          <AwesomeButton
      ...
      <div class="mb-6">
        ...
        <div class="mb-2">
          <div
            class="flex flex-col items-center md:flex-row space-y-2 md:space-x-2 md:space-y-0"
          >
