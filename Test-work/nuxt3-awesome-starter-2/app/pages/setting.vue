  ...
  <LayoutPageWrapper>
    ...
    <LayoutPageSection>
      <div class="mb-6">
        ...
        >
          <HeadlessTabList
            class="mb-2 w-full flex rounded-lg md:w-1/6 md:flex-col"
          >
            <HeadlessTab
            ...
            >
              <button
                class="rounded px-3 py-2.5 text-left text-sm leading-5 transition-all md:w-full hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-white/[0.12] dark:hover:text-white" :class="[
                  selected
                    ? 'font-extrabold'
          ...
          <HeadlessTabPanels class="flex-1">
            ...
            <HeadlessTabPanel>
              <AwesomeCard class="mb-6">
                ...
                <AwesomeCardFooter
                  class="md:space-y flex flex-col items-center md:flex-row md:justify-between space-y-2"
                >
                  <p>
                    Learn more about
                    <AwesomeLink
                  ...
                  <div class="flex">
                    <AwesomeFormTextInput v-model="id" class="w-full md:w-1/3">
                      <template #suffix>
                        <AwesomeButton
                          type="opposite"
                          class="flex border-none space-x-1"
                        >
