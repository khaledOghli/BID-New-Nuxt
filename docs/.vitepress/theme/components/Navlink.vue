    ...
    <div v-for="(item, index) in datas" :key="index">
      ...
      <div class="flink-list">
        <div v-for="(item2, index2) in item.items" :key="index2" class="flink-list-item">
          <a :href="item2.link" :title="item2.title" rel="external nofollow" target="_blank"
            ><img
            ...
            <div class="flink-item-info">
              <span class="flink-item-name">{{ item2.title }}</span
              ><span :title="item2.desc" class="flink-item-desc">{{ item2.desc }}</span>
            </div>
          </a>
        </div>
      </div>
...
<style>
  :root {
    ...
    --star-shadow-blackdeep: 0 2px 16px -3px rgba(0, 0, 0, 0.15);
    --star-shadow-main: 0 8px 12px -3px var(--star-main-op);
    --star-shadow-blue: 0 8px 12px -3px rgba(40, 109, 234, 0.2);
    --star-shadow-white: 0 8px 12px -3px rgba(255, 255, 255, 0.2);
    --star-shadow-black: 0 0 12px 4px rgba(0, 0, 0, 0.05);
    --star-shadow-yellow: 0px 38px 77px -26px rgba(255, 201, 62, 0.12);
    --star-shadow-red: 0 8px 12px -3px #ee7d7936;
    --star-shadow-green: 0 8px 12px -3px #87ee7936;
    --star-logo-color: linear-gradient(215deg, #0c1073 0%, #31a89a 100%);
    ...
    --star-shadow-lightblack: 0 5px 12px -5px rgba(102, 68, 68, 0);
  ...
  .site-card-tag.vip {
    ...
    background: -moz-linear-gradient(
      38deg,
      rgba(229, 176, 133, 1) 0%,
      rgba(212, 143, 22, 1) 100%
    );
    /* FF3.6+ */
