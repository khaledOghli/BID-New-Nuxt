...
import { useSSRContext, defineComponent, resolveComponent, mergeProps, withCtx, createTextVNode } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/server-renderer/index.mjs';
import { useForm } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vee-validate@4.12.8_vue@3.4.27_typescript@5.4.5_/node_modules/vee-validate/dist/vee-validate.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><form class="mx-auto w-full max-w-md rounded-lg p-8"><!-- <AuthHeader title="Register" subtitle="Please enter your credentials" /> -->`);
      ...
      _push(`<div class="mb-5 flex items-center justify-between gap-2"><label class="flex flex-wrap items-center gap-2 text-sm"><input type="checkbox" class="text-primary-500 focus:ring-primary-500 h-4 w-4 rounded transition duration-300"><span> I agree with </span>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createTextVNode(" Terms and Condition ")];
          }
        }),
        _: 1
        /* STABLE */
      ...
      _push(`<div class="text-sm text-gray-600"> Already have an account? `);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/auth/login",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("apps/auth/pages/auth/register.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const register = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/Users/khaledoghli/Work/BID-New-Nuxt/apps/auth/pages/auth/register.vue"]]);

export { register as default };
//# sourceMappingURL=register-BIxRkp3z.mjs.map
