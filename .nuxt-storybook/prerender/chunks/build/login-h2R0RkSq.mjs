import { createTextVNode, defineComponent, isRef, mergeProps, ref, resolveComponent, unref, useSSRContext, withCtx } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs';
import { ssrInterpolate, ssrRenderAttrs, ssrRenderComponent } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/server-renderer/index.mjs';
import { useField, useForm } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vee-validate@4.12.8_vue@3.4.27_typescript@5.4.5_/node_modules/vee-validate/dist/vee-validate.js';
import { object, string } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/yup@1.4.0/node_modules/yup/index.js';
import { _ as __nuxt_component_0 } from './nuxt-link-CLfuIrY3.mjs';
import { _ as __nuxt_component_0$1 } from './Button-DTtN7gXu.mjs';
import { _ as _export_sfc, u as useHead, c as useRoute, b as useRouter } from './server.mjs';
import { d as definePageMeta } from './composables-CKT5t5VU.mjs';
import { a as useAuthStorage, u as useAuthStore } from './auth-se_92EcM.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const {
      value: email,
    } = useField('email', void 0, {
      initialValue: '',
    });
    const {
      value: password,
    } = useField('password', void 0, {
      initialValue: '',
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_VButton = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: 'flex h-full items-center justify-center',
      }, _attrs))}><form class="mx-auto w-full max-w-md rounded-lg px-10 py-8"><!-- <AuthHeader title="Login" subtitle="Please enter your credentials" /> -->`);
      if (unref(error))
        _push(`<div class="bg-error-600 mb-4 rounded-lg px-4 py-3 text-sm text-white">${ssrInterpolate(unref(error))}</div>`);
      else
        _push('<!---->');
      ...
      _push('<div class="mb-5 flex items-center justify-between gap-2"><label class="flex items-center gap-2 text-sm"><input type="checkbox" class="text-primary-500 focus:ring-primary-500 h-4 w-4 rounded transition duration-300"> Remember me </label>');
      ...
      >
        Login
      </button> --><div class="text-sm text-gray-600"> Don&#39;t have account? `);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: '/auth/register',
        class: 'text-primary-500 text-sm font-semibold hover:underline',
      }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add('apps/auth/pages/auth/login.vue');
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const login = /* @__PURE__ */ _export_sfc(_sfc_main, [['__file', '/Users/khaledoghli/Work/BID-New-Nuxt/apps/auth/pages/auth/login.vue']]);

export { login as default };
// # sourceMappingURL=login-h2R0RkSq.mjs.map
