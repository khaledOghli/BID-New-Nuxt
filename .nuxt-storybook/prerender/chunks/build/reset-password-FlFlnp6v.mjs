...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><form class="mx-auto w-full max-w-md rounded-lg p-8"><!-- <AuthHeader
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add('apps/auth/pages/auth/reset-password.vue')
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0
}
const resetPassword = /* @__PURE__ */ _export_sfc(_sfc_main, [['__file', '/Users/khaledoghli/Work/BID-New-Nuxt/apps/auth/pages/auth/reset-password.vue']])

export { resetPassword as default }
// # sourceMappingURL=reset-password-FlFlnp6v.mjs.map
