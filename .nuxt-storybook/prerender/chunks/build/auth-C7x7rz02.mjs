import { defineComponent, mergeProps, resolveComponent, useSSRContext } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="lg:w-[400px]">`);
      _push(ssrRenderComponent(_component_Logo, {
        class: 'mb-5 flex justify-center',
      }, null, _parent));
      _push('<div class="rounded-xl bg-white shadow-md">');
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add('apps/auth/layouts/auth.vue');
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const auth = /* @__PURE__ */ _export_sfc(_sfc_main, [['__file', '/Users/khaledoghli/Work/BID-New-Nuxt/apps/auth/layouts/auth.vue']]);

export { auth as default };
// # sourceMappingURL=auth-C7x7rz02.mjs.map
