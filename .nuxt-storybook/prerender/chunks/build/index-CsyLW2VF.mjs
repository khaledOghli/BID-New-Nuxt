import script from './button.esm-DmUJJLCv.mjs';
import { _ as _export_sfc, u as useHead, a as useNuxtApp } from './server.mjs';
import { useSSRContext, defineComponent } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs';
...
import './baseicon.esm-DJCrXsDq.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><h1>Home</h1>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("apps/landing/pages/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/Users/khaledoghli/Work/BID-New-Nuxt/apps/landing/pages/index.vue"]]);

export { index as default };
//# sourceMappingURL=index-CsyLW2VF.mjs.map
