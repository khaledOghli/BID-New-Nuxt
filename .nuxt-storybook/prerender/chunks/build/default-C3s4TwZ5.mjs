...
import { u as useHead, B as BaseStyle, _ as _export_sfc, i as useRequestEvent, l as encodeParam, a as useNuxtApp, o as useLocaleHead, j as hasProtocol, w as withLeadingSlash, k as joinURL, p as parseURL, n as useRuntimeConfig, U as UniqueComponentId, O as ObjectUtils, Z as ZIndexUtils, D as DomHandler, R as Ripple, m as encodePath } from './server.mjs';
import { defineComponent, ref, computed, onMounted, h, useSSRContext, mergeProps, unref, createSlots, withCtx, renderSlot, resolveComponent, resolveDirective, openBlock, createBlock, createVNode, withDirectives, toDisplayString, createCommentVNode, createElementBlock, Fragment, renderList, createElementVNode, resolveDynamicComponent, normalizeClass, normalizeStyle, normalizeProps, guardReactiveProps } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrGetDirectiveProps, ssrInterpolate, ssrRenderClass } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/server-renderer/index.mjs';
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/image-meta@0.2.0/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("UI/components/MenuBar/index.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-211d9b93"], ["__file", "/Users/khaledoghli/Work/BID-New-Nuxt/UI/components/MenuBar/index.vue"]]);
      ...
      _push(ssrRenderComponent(_component_VMenuBar, {
        ...
        item: withCtx(({
          ...
          if (_push2) {
            ...
            }, props.action, ssrGetDirectiveProps(_ctx, _directive_ripple)))}${_scopeId}><span${_scopeId}>${ssrInterpolate(item.label)}</span>`);
            if (item.shortcut) {
              _push2(`<span class="border-1 surface-border border-round surface-100 ml-auto p-1 text-xs"${_scopeId}>${ssrInterpolate(item.shortcut)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            if (hasSubmenu) {
              _push2(`<i class="${ssrRenderClass(["pi pi-angle-down", {
            ...
            return [withDirectives((openBlock(), createBlock(
              ...
              [createVNode(
                ...
                1
                /* TEXT */
              ), item.shortcut ? (openBlock(), createBlock(
                "span",
                {
                  key: 0,
                ...
                1
                /* TEXT */
              )) : createCommentVNode("v-if", true), hasSubmenu ? (openBlock(), createBlock(
                "i",
                {
                  key: 1,
          ...
          if (_push2) {
            _push2(`<div class="align-items-center flex gap-2"${_scopeId}><div class="flex flex-col space-x-3 space-y-4 sm:flex-row sm:space-y-0 rtl:space-x-reverse"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ThemeSwitcher, null, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_LangSwitcher, null, null, _parent2, _scopeId));
            _push2(`</div></div>`);
          } else {
            ...
            }, [createVNode(_component_ThemeSwitcher), createVNode(_component_LangSwitcher)])])];
          }
        }),
        _: 1
        /* STABLE */
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/layout/SubMenu.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "/Users/khaledoghli/Work/BID-New-Nuxt/components/layout/SubMenu.vue"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><header class="mb-5"><div class="container mx-auto px-8"><nav class="flex flex-row justify-between pb-5 pt-10">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createVNode(_component_NuxtImg, {
              class: "h-6 sm:ml-3 lg:ml-0 dark:hidden",
              src: "nuxt/full-logo-green-dark.svg",
              densities: "x1 x2",
              alt: "nuxt-logo",
      ...
      _push(`</header><div class="main_content container mx-auto px-8"><div class="rounded-2xl bg-white px-6 py-8 shadow-xl dark:bg-slate-800">`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></div><footer class="sticky_footer py-20 text-center text-sm text-gray-600 dark:bg-slate-900"><div class="container mx-auto max-w-screen-lg px-8"><p> \xA9 ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} - ${ssrInterpolate(_ctx.$t("site.name"))}</p></div></footer></div>`);
    };
  }
});
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/Users/khaledoghli/Work/BID-New-Nuxt/layouts/default.vue"]]);
