import { computed, defineComponent, mergeProps, useSSRContext } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs'
import { ssrRenderAttrs } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/server-renderer/index.mjs'
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        '--113189bb-iconUrl': iconUrl.value,
      } }
      _push(`<span${ssrRenderAttrs(mergeProps({
        style: { width: sSize.value, height: sSize.value },
      }, _attrs, _cssVars))} data-v-113189bb></span>`)
    }
  },
})
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add('node_modules/.pnpm/nuxt-icon@0.6.10_nuxt@3.11.2_@opentelemetry+api@1.8.0_@parcel+watcher@2.4.1_@types+node@20.12_jxtntewwdssv5p3iyt44weljrq/node_modules/nuxt-icon/dist/runtime/IconCSS.vue')
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0
}
const IconCSS = /* @__PURE__ */ _export_sfc(_sfc_main, [['__scopeId', 'data-v-113189bb'], ['__file', '/Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/nuxt-icon@0.6.10_nuxt@3.11.2_@opentelemetry+api@1.8.0_@parcel+watcher@2.4.1_@types+node@20.12_jxtntewwdssv5p3iyt44weljrq/node_modules/nuxt-icon/dist/runtime/IconCSS.vue']])

export { IconCSS as default }
// # sourceMappingURL=IconCSS-DfCkCYUo.mjs.map
