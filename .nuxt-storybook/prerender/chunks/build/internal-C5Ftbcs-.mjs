import { mergeProps, useSSRContext } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  }, _attrs))}><!-- <LayoutPageNavbar class="h-[64px] max-h-[64px]" />
    <LayoutPageContent>
      <slot />
    </LayoutPageContent>
    <LayoutPageFooter class="h-[52px] md:h-[42px]" /> --></div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add('layouts/internal.vue');
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const internal = /* @__PURE__ */ _export_sfc(_sfc_main, [['ssrRender', _sfc_ssrRender], ['__file', '/Users/khaledoghli/Work/BID-New-Nuxt/layouts/internal.vue']]);

export { internal as default };
// # sourceMappingURL=internal-C5Ftbcs-.mjs.map
