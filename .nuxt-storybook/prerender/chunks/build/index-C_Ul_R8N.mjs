import { createTextVNode, createVNode, defineComponent, mergeProps, ref, resolveDynamicComponent, unref, useSSRContext, withCtx } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs'
import { ssrInterpolate, ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrRenderList, ssrRenderVNode } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/server-renderer/index.mjs'
import { _ as __nuxt_component_0 } from './nuxt-link-CLfuIrY3.mjs'
import { _ as _export_sfc } from './server.mjs'
import { _ as __nuxt_component_1$1 } from './Card-BzdzGKPV.mjs'
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: 'flex items-center gap-4 rounded-xl border border-gray-200 bg-white px-4 py-3',
      }, _attrs))}><div class="${ssrRenderClass([_ctx.color, 'flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full text-white'])}">`)
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(_ctx.icon), {
        class: 'h-5 w-5',
      }, null), _parent)
      _push(`</div><div><h3 class="truncate text-xl font-semibold">${ssrInterpolate(_ctx.count)}</h3><h4 class="text-gray-600">${ssrInterpolate(_ctx.text)}</h4></div></div>`)
    }
  },
})
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add('apps/dashboard/components/admin/metric/Item.vue')
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0
}
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [['__file', '/Users/khaledoghli/Work/BID-New-Nuxt/apps/dashboard/components/admin/metric/Item.vue']])
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AdminMetricItem = __nuxt_component_1
      const _component_VCard = __nuxt_component_1$1
      ...
      _push('<div class="text-gray-500">Overview &amp; summary</div></div><!-- stats --><div class="mb-5 grid grid-cols-2 gap-5 sm:grid-cols-4"><!--[-->')
      ssrRenderList(unref(stats), (stat) => {
        _push(ssrRenderComponent(_component_AdminMetricItem, mergeProps({
          key: stat.text,
          ref_for: true,
        }, stat), null, _parent))
      })
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add('apps/dashboard/pages/dashboard/index.vue')
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0
}
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [['__file', '/Users/khaledoghli/Work/BID-New-Nuxt/apps/dashboard/pages/dashboard/index.vue']])

export { index as default }
// # sourceMappingURL=index-C_Ul_R8N.mjs.map
