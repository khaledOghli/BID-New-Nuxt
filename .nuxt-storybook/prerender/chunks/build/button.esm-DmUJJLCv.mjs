import { createBlock, createCommentVNode, createElementBlock, createElementVNode, createTextVNode, mergeProps, normalizeClass, openBlock, renderSlot, resolveComponent, resolveDirective, toDisplayString, withDirectives } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs';
import { B as BaseStyle, O as ObjectUtils, R as Ripple } from './server.mjs';
import { a as script$1$2, s as script$4 } from './baseicon.esm-DJCrXsDq.mjs';
...
const classes$1 = {
  root: function root(_ref) {
    const props = _ref.props; const instance = _ref.instance;
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock('span', mergeProps({
    class: _ctx.cx('root'),
  }, _ctx.ptmi('root')), [renderSlot(_ctx.$slots, 'default', {}, () => {
...
const classes = {
  root: function root2(_ref) {
    const instance = _ref.instance; const props = _ref.props;
...
const _hoisted_1 = ['aria-label', 'disabled', 'data-p-severity'];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock('button', mergeProps({
    ...
    return [_ctx.loading
      ...
      class: _ctx.cx('label'),
    }, _ctx.ptm('label')), toDisplayString(_ctx.label || '\xA0'), 17), _ctx.badge
      ? (openBlock(), createBlock(_component_Badge, mergeProps({
          key: 2,
          value: _ctx.badge,
          class: _ctx.badgeClass,
          severity: _ctx.badgeSeverity,
          unstyled: _ctx.unstyled,
        }, _ctx.ptm('badge')), null, 16, ['value', 'class', 'severity', 'unstyled']))
      : createCommentVNode('', true)];
...
// # sourceMappingURL=button.esm-DmUJJLCv.mjs.map
