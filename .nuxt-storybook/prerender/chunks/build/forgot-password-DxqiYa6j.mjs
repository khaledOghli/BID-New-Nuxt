import { _ as __nuxt_component_0 } from './Button-DTtN7gXu.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_VButton = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "flex h-full items-center justify-center"
      }, _attrs))}><form class="mx-auto w-full max-w-md rounded-lg p-8"><!-- <AuthHeader title="Forgot Password" subtitle="Please enter your email" /> -->`);
      ...
      _push(ssrRenderComponent(_component_VButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createTextVNode(" Send Password Reset Link ")];
          }
        }),
        _: 1
        /* STABLE */
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("apps/auth/pages/auth/forgot-password.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const forgotPassword = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/Users/khaledoghli/Work/BID-New-Nuxt/apps/auth/pages/auth/forgot-password.vue"]]);

export { forgotPassword as default };
//# sourceMappingURL=forgot-password-DxqiYa6j.mjs.map
