import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, toRef, isRef, defineComponent, onMounted, provide, createElementBlock, defineAsyncComponent, h, onUnmounted, readonly, computed, unref, shallowReactive, Suspense, nextTick, Transition, useSSRContext, Fragment, mergeProps, resolveComponent, withCtx, createVNode, createApp, effectScope, reactive, markRaw, isReactive, toRaw, shallowRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, getCurrentScope, onScopeDispose, isReadonly, toRefs, Text, isShallow } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs';
...
import { getRequestHeader, sanitizeStatusCode, setCookie, getCookie, deleteCookie, createError as createError$1, getRequestHeaders } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/h3@1.11.1/node_modules/h3/dist/index.mjs';
...
import { defineHeadPlugin, composableNames } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/@unhead+shared@1.9.11/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue-router@4.3.2_vue@3.4.27_typescript@5.4.5_/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
...
import { ssrRenderComponent, ssrRenderAttrs, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/khaledoghli/Work/BID-New-Nuxt/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/server-renderer/index.mjs';
...
const useSweetAlert = (options, confirmCallback, dismissedCallback, deniedCallback) => {
  const preConfirm = () => {
    return new Promise((resolve2) => {
      setTimeout(() => {
        resolve2();
