            ...
            <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
              ...
              <div>
                ...
                <div class="mt-1 flex items-center">
                  ...
                  <button
                    type="button"
                    class="ml-5 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                    Change
                  </button>
                </div>
              </div>
